...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="../Assets/Template/Admin/src/assets/images/logos/favicon.png" />
      ...
      <div>
        <!-- <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="../Assets/Template/Admin/src/assets/images/logos/dark-logo.svg" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Class.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Subject.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Studentlist.php" aria-expanded="false">
                <span>
                  <i class="ti ti-typography"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Tutorlist.php" aria-expanded="false">
                <span>
                  <i class="ti ti-typography"></i>
                </span>
                <span class="hide-menu">Tutor List</span>
              </a>
            </li>
            <li class="sidebar-item">
          ...
          <!-- <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
            <div class="d-flex">
              ...
              <!-- <div class="unlimited-access-img">
                <img src="../Assets/Template/Admin/src/assets/images/backgrounds/rocket.png" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </nav> -->
